  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: DatabaseService().getTakenCollection(),
        builder: (context, snapshot) {
          ...
          for (var doc in snapshot.data!.docs) {
            ...
            final DateTime takenDate = data['takenAt'].toDate();
                  ...
                  return ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => TakenDetailScreen(
                            ...
                            formattedTakenDate:
                                "${item['takenAt'].toDate().day} ${_monthName(item['takenAt'].toDate().month)} ${item['takenAt'].toDate().year}",
